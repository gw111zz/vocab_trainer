...
import { importObject, setWasmExports } from './LanguageLearner-webApp.import-object.mjs'
...
const wasmFilePath = './LanguageLearner-webApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./LanguageLearner-webApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
